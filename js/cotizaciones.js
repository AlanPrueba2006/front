    ...
    userCotizaciones.forEach((cot) => {
      ...
      card.innerHTML = `
        <div class="card-body">
          ...
          <p class="mb-1"><strong>Invitados:</strong> ${
            cot.numero_invitados
          }</p>
          ${
            cot.precio
              ? `<p class="mb-1"><strong>Precio:</strong> S/ ${cot.precio}</p>`
              : ""
          }
          ${
            estado === "pendiente"
...
document
  .getElementById("cerrarSesionLateral")
